    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="types.php">Personality Types</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link">|</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="check.php">Login</a>
                </li>
            </ul>
        </div>
    </nav> 
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            ...
                            <p class="p-large">Take our Personality Test and get a “freakishly accurate” description of who you are and why you do things the way you do.</p>
                            <a class="btn-solid-lg page-scroll" href="check.php">Check Your Type</a>
                        </div> 
                    </div> 
                    <div class="col-lg-6">
